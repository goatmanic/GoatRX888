...
#define fprintf(err, s, ...) DebugPrint(4, s, ##__VA_ARGS__)
#endif
...
UINT8 m_gain_index = -1;
UINT8 m_lnagain_index  = -1;
UINT8 m_vgagain_index = -1;
UINT8 m_mixergain_index = -1;
...
int set_all_gains(struct r82xx_priv *priv, UINT8 gain_index)
{
	...
	uint8_t data[4];
	uint8_t lna_gain_idx, mixer_gain_idx;
	lna_gain_idx = lna_gains [ gain_index ];
	mixer_gain_idx = mixer_gains [ gain_index ];
